...
import RowVehEtape from '../Etapes/rowVehEtape'
import OneVehicule from '../VehiculeComponents/OneVehicule';
...
export default function MatableSuiPro({rows}) {
...
export function MatableSuiEtapes ({rows}) {
  const [page, setPage] = React.useState(0);
  const [rowsPerPage, setRowsPerPage] = React.useState(5);
      ...
      <TableHead style={{ background: 'rgb(158 158 158)' }} >
          <TableRow>
              <TableCell>Numero</TableCell>
                  <TableCell>Numero de chassis</TableCell>
